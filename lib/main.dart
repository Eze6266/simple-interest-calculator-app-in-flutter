...
class _SIFormState extends State<SIForm> {
  ...
  Widget getImageAsset() {
    AssetImage assetImage = AssetImage('images/angula.jpg');
    Image image = Image(
      image: assetImage,
      width: 125.0,
      height: 125.0,
  ...
  String? _calculateReturns() {
    ...
    double totalAmouuntPayable = principal + (principal * roi * term) / 100;

    String result =
        'After $term years, your investment will be worth $totalAmouuntPayable $_currentItemSelected';
    return result;
  }
